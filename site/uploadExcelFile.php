...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["upfile"])) {
    ...
    if ($file["error"] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file_tmp_name, $destination)) {
            ...
            echo "Using lookup table with file name: MasterRegionalStageBivalveTweaks4Nov2025.xlsx";
            $geologicalStages = parseGeologicalStages("./uploads/MasterRegionalStageBivalveTweaks4Nov2025.xlsx");
            $columns = [];
            if ($xlsx === false) {
